...
<body class="body-register background">
	...
	<div class="register">
		...
		<div class="cuenta-registrada">
	
		<img src="/images/LogoPngBorde.png" alt="img-logo" class="register-img">
		 <a class="btn btn-info mt-3" href="/login">Inicia Sesión</a> 
